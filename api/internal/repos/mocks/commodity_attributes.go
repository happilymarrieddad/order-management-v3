...
// Source: internal/repos/commodity_attributes.go
//
// Generated by this command:
//
//	mockgen -source=internal/repos/commodity_attributes.go -destination=internal/repos/mocks/commodity_attributes.go -package=mock_repos CommodityAttributesRepo
//
